...
public class Driver {
	public static void main(String[] args) throws SQLException {
		...
		String tableName = "employee", filePath, type = null;
		int ch;
					...
					case 2:
						...
						if (dbactions.searchColumn(Integer.toString(emp_edit.getId()), tableName, "id")) {
							...
							if ((sc.next().charAt(0) == 'y')) {
								...
								dbactions.updateRecord(emp_edit.getName(), columnString[0], emp_edit.getId(),
										tableName);
							}
							...
							if ((sc.next().charAt(0) == 'y')) {
								...
								dbactions.updateRecord(emp_edit.getNumber(), columnString[1], emp_edit.getId(),
										tableName);
							}
					...
					case 4:
						...
						if ((sc.next().charAt(0) == 'y')) {
							...
							if (dbactions.searchColumn(emp_view.getName(), tableName, "name")) {
								helper.printHeading();
								emp_view.setId(
										(int) dbactions.getColumnValue(emp_view.getName(), tableName, "name", "id"));
								helper.parseRecords(
										dbactions.getColumn(Integer.toString(emp_view.getId()), tableName, "id"), true,
										true);
							} else {
